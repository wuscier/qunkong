...
namespace Wx.Qunkong360.Wpf
{
    ...
    public partial class MainView
    {
        ...
        {
            TimedTaskManager.Instance.StartCheckingTimedTasks();
            ...
            EventAggregatorManager.Instance.EventAggregator.GetEvent<GroupVmsTriggerEvent>().Subscribe((groupIndex) =>
            {
                var targetButton = _groupButtons.FirstOrDefault(btn => btn.Tag.ToString() == groupIndex.ToString());
            ...
            tbCopyright1.Text = SystemLanguageManager.Instance.ResourceManager.GetString("CopyRight1", SystemLanguageManager.Instance.CultureInfo);
            tbCopyright2.Text = SystemLanguageManager.Instance.ResourceManager.GetString("CopyRight2", SystemLanguageManager.Instance.CultureInfo);
